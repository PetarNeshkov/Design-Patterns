using System;
using MediatorLibrary.AirTrafficControl.Components;
using MediatorLibrary.AirTrafficControl.Mediators;

namespace MediatorLibrary.AirTrafficControl;

public static class AirTrafficControlExecutor
{
    public static void Execute()
    {
        Console.WriteLine("Air traffic control example");
