...
namespace ProxyLibrary.CachingProxyExample.Manager
{
    ...
    {
        private readonly IYoutubeOperations youtubeOperations;

        public YoutubeManager(IYoutubeOperations youtubeOperations)
        {
            this.youtubeOperations = youtubeOperations;
        }
        ...
        public void RenderHomepage()
        {
            ...
            foreach (var homepageItem in youtubeOperations.ShowHomepage())
            {
        ...
        public void PlayVideo(int id)
        {
            ...
            var metadata = youtubeOperations.GetVideoMetadata(id);
            Console.WriteLine($"Metadata loaded...Name: '{metadata.Name}' and description: '{metadata.Description}'");

            var video = youtubeOperations.DownloadVideo(id);
